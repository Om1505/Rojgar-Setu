...
const JobPost = () => {
  ...
  const [responsibilities,setRespnsibilities]=useState("");
  ...
  return (
    ...
    <div>
      <label>Comapny/Job Introduction</label>
      <textarea value={introduction} onChange={(e)=>setIntroduction(e.target.value)} placeholder='Company/Job Introduction' rows={7}/>
    </div>
    <div>
      <label>Responsibilities</label>
      <textarea value={responsibilities} onChange={(e)=>setRespnsibilities(e.target.value)} placeholder='Job Responsibilities' rows={7}/>
    </div>
    <div>
