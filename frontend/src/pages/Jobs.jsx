            ...
            <section className='jobs'>
              ...
              <div className="wrapper">
                <div className="filter-bar">
                  ...
                  <div className="cities">
                    <h2>Filter Job By Preferences</h2>
                    {
                ...
                <div className="container">
                  <div className="mobile-filter">
                    ...
                    <select value={niche} onChange={(e)=>setNiche(e.target.value)}>
                      <option value="">Filter By Preferences</option>
                      {
                        nichesArray.map((niche,index)=>(
                        ...
                        return(
                          <div className="card" key={element._id}>
                            {element.hiringMultipleCandidates==="Yes"?(
                              ...
                              <span className="hiring-multiple">{element.salary}/year </span>
                              </>
                            ):(
                              <>
                              <span className="hiring">Hiring</span>
                              <span className="hiring">{element.salary}/year </span>
                              </>
                            )}
